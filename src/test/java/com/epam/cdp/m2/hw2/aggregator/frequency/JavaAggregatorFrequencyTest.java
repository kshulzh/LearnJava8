...
public abstract class JavaAggregatorFrequencyTest {
    ...
    public static List<Object[]> data() {
        ...
        data.add(new Object[]{2, asList("b", "f", "c", "b", "b", "c"), asList(new Pair<>("b", 3L), new Pair<>("c", 2L))});

        data.add(new Object[]{2, asList("f", "c", "b", "b", "b", "f"), asList(new Pair<>("b", 3L), new Pair<>("f", 2L))});
